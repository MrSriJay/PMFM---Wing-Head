...
class WingClientController extends Controller
{
    public function index()
    {
        $clients = Client::orderBy('updated_at', 'DESC')->get();
        return view('winghead.view-clients')->with('clients',$clients);
    }

    public function create()
    {
       return view('winghead.add-clients');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($data === null) 
        {
            ...
            return redirect('/winghead/clients')->with('status', 'Client Added Successfully');
        }
        else
        {
            $validate = \Validator::make($request->all(), [
    ...
    public function show($id){
        ...
        return view('winghead.view-client-details')->with('clients', $clients);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/winghead/clients')->with('status','User Deleted Successfully!');
    }
    ...
    public function update (Request $request, $id)
    {
        ...
        return redirect('/winghead/clients')->with('status','Client Details Updated Successfully!');
    }
