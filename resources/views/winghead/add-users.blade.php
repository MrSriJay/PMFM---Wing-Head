    ...
    <div class="card">
      ...
      {{ csrf_field() }}
          ...
          <div class="form-group py-4">
              ...
              <input type="text" name ="rank" id ="rank"class="form-control @error('rank') is-invalid @enderror" value="{{ old('rank') }}"  placeholder="e.g. Major / Mr"  value="">
              @error('rank')
              <span class="invalid-feedback" role="alert">
              <strong>{{ $message }}</strong>
              </span>
          ...
          <div class="form-group py-4">
           ...
           <div class="form-group py-4">
              ...
              <select id="usertype" class="form-select  @error('usertype') is-invalid @enderror" name="usertype" required value="{{ old('usertype') }}"  aria-label="Default select example" >
