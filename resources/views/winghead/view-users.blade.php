              ...
              @if(count($users)>0)
                @foreach ($users as $data)
                  <tr>
                    ...
                    <th scope="row">
                     <a class="btn btn-secondary btn-sm mx-auto " href="/winghead/wings-users/{{$data->user_id}}"  style="width:100%">View More <span class="material-icons">chevron_right</span></a>
                    </th>
