  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header card-header-primary"> 
          @if(Auth::user()->usertype == "winghead" || Auth::user()->usertype=="hq")
            <a href="/winghead/clients/create" class="btn btn-success float-right" style="margin:20px" data-toggle="" data-target="" > <i class="material-icons">add</i> Add Client</a>
          @endif
              ...
              <tbody>
                ...
                @foreach ($clients as $data)
                  <tr>
                    ...
                    <th scope="row">
                     <a class="btn btn-secondary btn-sm mx-auto " href="/winghead/clients/{{$data->id}}"  style="width:100%">View More <span class="material-icons">chevron_right</span></a>
                    </th>
                  </tr>
                  @endforeach
                @else 
