...
<div class="card">
  <div class="card-header card-header-primary"> 
    <label for="recipient-name" class="col-form-label text-light text-lg">Change Password</label>
  </div>
  <div class="card-body">
    ...
    <div class="col-lg-6">
      ...
      <input id="current_password" type="password" placeholder="*********" class="form-control @error('current_password') is-invalid @enderror" name="current_password"  required autocomplete="new-password">
