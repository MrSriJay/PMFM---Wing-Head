                    ...
                    {{ csrf_field() }}
                      ...
                      <!--Insert Proejct Ichage-->
                        <div class="form-group  py-4">
                            ...
                            <select id="developer_name" class="livesearch form-control @error('supervisor') is-invalid @enderror" name="supervisor" value="{{ old('supervisor') }}" style="width:99%;"  required></select>
                        ...
                        <div class="form-group  py-4">
                            ...
                            <select  class="livesearch form-control @error('wing_name') is-invalid @enderror" name="wing_name" readonly  value="{{ old('wing_name') }}" style="width:99%;"  required>
