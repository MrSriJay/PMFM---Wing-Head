...
<div class="row">
    <div class="col-md-12">
        <div class="card">  
            {{ Form::open([ 'method'  => 'PATCH', 'route' => [ 'wings-projects.update', $project->id ], 'enctype'=> 'multipart/form-data' ]) }}
                {{ csrf_field() }}
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                {{ Form::open([ 'method'  => 'delete', 'route' => [ 'wings-projects.destroy', $project->id ] ]) }}
                <div class="modal-footer">
