    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-primary"> 
          <a href="/admin/projects/create" class="btn btn-success float-right" style="margin:20px" data-toggle="" data-target="">Add New Project</a>
            ...
            @if(count($project)>0)
              @foreach ($project as $data)
                <div class="card">
                  ...
                  <h3><a class="card-title text-primary" href="admin/projects/{{$data->id}}">{{$data->title}}</a></h3>
